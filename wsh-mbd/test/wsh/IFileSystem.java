...
public interface IFileSystem extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.wsh.IDriveCollection
   */

  @DISPID(10010) //= 0x271a. The runtime will prefer the VTID if present
  @VTID(7)
  test.wsh.IDriveCollection drives();


  @VTID(7)
  @ReturnValue(defaultPropertyThrough={test.wsh.IDriveCollection.class})
  test.wsh.IDrive drives(
   ...
   * @return  Returns a value of type test.wsh.ITextStream
   */

  @DISPID(1101) //= 0x44d. The runtime will prefer the VTID if present
  @VTID(30)
  test.wsh.ITextStream createTextFile(
  ...
  @VTID(31)
  test.wsh.ITextStream openTextFile(
    java.lang.String fileName,
    @Optional @DefaultValue("1") test.wsh.IOMode ioMode,
    @Optional @DefaultValue("0") boolean create,
    @Optional @DefaultValue("0") test.wsh.Tristate format);

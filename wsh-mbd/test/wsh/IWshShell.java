...
public interface IWshShell extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.wsh.IWshCollection
   */

  @DISPID(100) //= 0x64. The runtime will prefer the VTID if present
  @VTID(7)
  test.wsh.IWshCollection specialFolders();


  @VTID(7)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={test.wsh.IWshCollection.class})
   ...
   * @return  Returns a value of type test.wsh.IWshEnvironment
   */

  @DISPID(200) //= 0xc8. The runtime will prefer the VTID if present
  @VTID(8)
  test.wsh.IWshEnvironment environment(

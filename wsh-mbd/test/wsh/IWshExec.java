...
public interface IWshExec extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.wsh.WshExecStatus
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(7)
  test.wsh.WshExecStatus status();

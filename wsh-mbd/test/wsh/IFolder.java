...
public interface IFolder extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.wsh.FileAttribute
   */

  @DISPID(1003) //= 0x3eb. The runtime will prefer the VTID if present
  @VTID(14)
  test.wsh.FileAttribute attributes();
   ...
   * </p>
   * @param pfa Mandatory test.wsh.FileAttribute parameter.
   */

  @DISPID(1003) //= 0x3eb. The runtime will prefer the VTID if present
  @VTID(15)
  void attributes(
    test.wsh.FileAttribute pfa);
   ...
   * </p>
   * @return  Returns a value of type test.wsh.IFolderCollection
   */

  @DISPID(10001) //= 0x2711. The runtime will prefer the VTID if present
  @VTID(25)
  test.wsh.IFolderCollection subFolders();


  @VTID(25)
  @ReturnValue(defaultPropertyThrough={test.wsh.IFolderCollection.class})
  test.wsh.IFolder subFolders(
   ...
   * </p>
   * @return  Returns a value of type test.wsh.IFileCollection
   */

  @DISPID(10002) //= 0x2712. The runtime will prefer the VTID if present
  @VTID(26)
  test.wsh.IFileCollection files();


  @VTID(26)
  @ReturnValue(defaultPropertyThrough={test.wsh.IFileCollection.class})
  test.wsh.IFile files(
    @MarshalAs(NativeType.VARIANT) java.lang.Object key);

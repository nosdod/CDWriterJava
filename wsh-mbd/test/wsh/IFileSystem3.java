...
public interface IFileSystem3 extends test.wsh.IFileSystem {
  // Methods:
  /**
   * @param standardStreamType Mandatory test.wsh.StandardStreamTypes parameter.
  ...
  @VTID(32)
  test.wsh.ITextStream getStandardStream(
    test.wsh.StandardStreamTypes standardStreamType,

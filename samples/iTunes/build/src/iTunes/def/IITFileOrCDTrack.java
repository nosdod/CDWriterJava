...
public interface IITFileOrCDTrack extends iTunes.def.IITTrack {
   ...
   * </p>
   * @return  Returns a value of type iTunes.def.ITVideoKind
   */
   ...
   * </p>
   * @param videoKind Mandatory iTunes.def.ITVideoKind parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type iTunes.def.ITRatingKind
   */

  @DISPID(1610874935) //= 0x60040037. The runtime will prefer the VTID if present
  @VTID(127)
  iTunes.def.ITRatingKind albumRatingKind();
  ...
  @VTID(128)
  iTunes.def.ITRatingKind ratingKind();

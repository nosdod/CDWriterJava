...
public interface IFileSystemImage extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type imapi2fs.IFsiDirectoryItem
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(7)
  @DefaultMethod
  imapi2fs.IFsiDirectoryItem getRoot();


  @VTID(7)
  @ReturnValue(defaultPropertyThrough={imapi2fs.IFsiDirectoryItem.class})
  imapi2fs.IFsiItem getRoot(
   ...
   * </p>
   * @param discRecorder Mandatory imapi2fs.IDiscRecorder2 parameter.
   */

  @DISPID(36) //= 0x24. The runtime will prefer the VTID if present
  @VTID(12)
  void setMaxMediaBlocksFromDevice(
    imapi2fs.IDiscRecorder2 discRecorder);
  ...
  @VTID(16)
  java.lang.String getImportedVolumeName();
   ...
   * </p>
   * @return  Returns a value of type imapi2fs.IBootOptions
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(17)
  imapi2fs.IBootOptions getBootImageOptions();
   ...
   * </p>
   * @param pVal Mandatory imapi2fs.IBootOptions parameter.
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(18)
  void setBootImageOptions(
    imapi2fs.IBootOptions pVal);
  ...
  @VTID(24)
  boolean getStrictFileSystemCompliance();
  ...
  @DISPID(11) //= 0xb. The runtime will prefer the VTID if present
  @VTID(25)
  void setStrictFileSystemCompliance(
    boolean pVal);
  ...
  @VTID(26)
  boolean getUseRestrictedCharacterSet();
  ...
  @DISPID(12) //= 0xc. The runtime will prefer the VTID if present
  @VTID(27)
  void setUseRestrictedCharacterSet(
    boolean pVal);
   ...
   * </p>
   * @return  Returns a value of type imapi2fs.FsiFileSystems
   */

  @DISPID(13) //= 0xd. The runtime will prefer the VTID if present
  @VTID(28)
  imapi2fs.FsiFileSystems getFileSystemsToCreate();
   ...
   * </p>
   * @param pVal Mandatory imapi2fs.FsiFileSystems parameter.
   */

  @DISPID(13) //= 0xd. The runtime will prefer the VTID if present
  @VTID(29)
  void setFileSystemsToCreate(
    imapi2fs.FsiFileSystems pVal);
  ...
  @VTID(30)
  imapi2fs.FsiFileSystems getFileSystemsSupported();
  ...
  @VTID(33)
  java.lang.Object[] getUDFRevisionsSupported();
   ...
   * </p>
   * @param value Mandatory imapi2fs.IMAPI_MEDIA_PHYSICAL_TYPE parameter.
   */

  @DISPID(33) //= 0x21. The runtime will prefer the VTID if present
  @VTID(35)
  void chooseImageDefaultsForMediaType(
    imapi2fs.IMAPI_MEDIA_PHYSICAL_TYPE value);
  ...
  @VTID(36)
  void setISO9660InterchangeLevel(
    int pVal);
  ...
  @VTID(38)
  java.lang.Object[] getISO9660InterchangeLevelsSupported();
   ...
   * </p>
   * @return  Returns a value of type imapi2fs.IFileSystemImageResult
   */

  @DISPID(15) //= 0xf. The runtime will prefer the VTID if present
  @VTID(39)
  imapi2fs.IFileSystemImageResult createResultImage();
   ...
   * @return  Returns a value of type imapi2fs.FsiItemType
   */

  @DISPID(16) //= 0x10. The runtime will prefer the VTID if present
  @VTID(40)
  imapi2fs.FsiItemType exists(
  ...
  @VTID(42)
  imapi2fs.FsiFileSystems identifyFileSystemsOnDisc(
    imapi2fs.IDiscRecorder2 discRecorder);
   ...
   * </p>
   * @param fileSystems Mandatory imapi2fs.FsiFileSystems parameter.
   * @return  Returns a value of type imapi2fs.FsiFileSystems
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(43)
  imapi2fs.FsiFileSystems getDefaultFileSystemForImport(
    imapi2fs.FsiFileSystems fileSystems);
  ...
  @VTID(44)
  imapi2fs.FsiFileSystems importFileSystem();
   ...
   * </p>
   * @param fileSystemToUse Mandatory imapi2fs.FsiFileSystems parameter.
   */

  @DISPID(22) //= 0x16. The runtime will prefer the VTID if present
  @VTID(45)
  void importSpecificFileSystem(
    imapi2fs.FsiFileSystems fileSystemToUse);
  ...
  @VTID(48)
  imapi2fs.IFsiDirectoryItem createDirectoryItem(
   ...
   * </p>
   * @param name Mandatory java.lang.String parameter.
   * @return  Returns a value of type imapi2fs.IFsiFileItem
   */

  @DISPID(26) //= 0x1a. The runtime will prefer the VTID if present
  @VTID(49)
  imapi2fs.IFsiFileItem createFileItem(
    java.lang.String name);
  ...
  @VTID(50)
  java.lang.String getVolumeNameUDF();
  ...
  @VTID(51)
  java.lang.String getVolumeNameJoliet();
  ...
  @VTID(52)
  java.lang.String getVolumeNameISO9660();
  ...
  @VTID(55)
  java.lang.Object[] getMultisessionInterfaces();
  ...
  @DISPID(40) //= 0x28. The runtime will prefer the VTID if present
  @VTID(56)
  void setMultisessionInterfaces(

...
public interface IFsiDirectoryItem extends imapi2fs.IFsiItem,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type imapi2fs.IFsiItem
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(20)
  @DefaultMethod
  imapi2fs.IFsiItem getItem(
   ...
   * </p>
   * @return  Returns a value of type imapi2fs.IEnumFsiItems
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(22)
  imapi2fs.IEnumFsiItems getEnumFsiItems();
   ...
   * </p>
   * @param path Mandatory java.lang.String parameter.
   * @param fileData Mandatory imapi2fs.IStream parameter.
   */
   ...
   * Add an item
   * </p>
   * @param item Mandatory imapi2fs.IFsiItem parameter.
   */

  @DISPID(33) //= 0x21. The runtime will prefer the VTID if present
  @VTID(26)
  void add(
    imapi2fs.IFsiItem item);

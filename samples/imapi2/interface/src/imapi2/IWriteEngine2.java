...
public interface IWriteEngine2 extends Com4jObject {
   ...
   * </p>
   * @param value Mandatory imapi2.IDiscRecorder2Ex parameter.
   */

  @DISPID(256) //= 0x100. The runtime will prefer the VTID if present
  @VTID(9)
  void setRecorder(
    imapi2.IDiscRecorder2Ex value);
   ...
   * </p>
   * @return  Returns a value of type imapi2.IDiscRecorder2Ex
   */

  @DISPID(256) //= 0x100. The runtime will prefer the VTID if present
  @VTID(10)
  imapi2.IDiscRecorder2Ex getRecorder();
  ...
  @DISPID(257) //= 0x101. The runtime will prefer the VTID if present
  @VTID(12)
  boolean getUseStreamingWrite12();
  ...
  @VTID(13)
  void setStartingSectorsPerSecond(
    int value);
  ...
  @DISPID(258) //= 0x102. The runtime will prefer the VTID if present
  @VTID(14)
  int getStartingSectorsPerSecond();
  ...
  @VTID(15)
  void setEndingSectorsPerSecond(
    int value);

...
public interface IConnectionPoint extends Com4jObject {
  ...
  /**
   * @return  Returns a value of type imapi2.IConnectionPointContainer
   */

  @VTID(4)
  imapi2.IConnectionPointContainer getConnectionPointContainer();
  ...
  /**
   * @return  Returns a value of type imapi2.IEnumConnections
   */

  @VTID(7)
  imapi2.IEnumConnections enumConnections();

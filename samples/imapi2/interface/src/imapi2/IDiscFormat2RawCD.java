...
public interface IDiscFormat2RawCD extends imapi2.IDiscFormat2 {
  // Methods:
  /**
   * <p>
  ...
  @VTID(23)
  int getLastPossibleStartOfLeadout();
  ...
  @VTID(25)
  java.lang.Object[] getSupportedSectorTypes();
  ...
  @DISPID(265) //= 0x109. The runtime will prefer the VTID if present
  @VTID(27)
  imapi2.IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE getRequestedSectorType();

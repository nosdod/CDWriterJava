...
public interface IDiscFormat2 extends Com4jObject {
   ...
   * </p>
   * @param recorder Mandatory imapi2.IDiscRecorder2 parameter.
  ...
  boolean isRecorderSupported(
    imapi2.IDiscRecorder2 recorder);
  ...
  @VTID(9)
  boolean getMediaPhysicallyBlank();
  ...
  @VTID(10)
  boolean getMediaHeuristicallyBlank();
  ...
  @VTID(11)
  java.lang.Object[] getSupportedMediaTypes();

...
public interface IDiscFormat2Data extends imapi2.IDiscFormat2 {
  // Methods:
  /**
   * <p>
  ...
  @VTID(14)
  void setBufferUnderrunFreeDisabled(
    boolean value);
  ...
  @DISPID(257) //= 0x101. The runtime will prefer the VTID if present
  @VTID(15)
  boolean getBufferUnderrunFreeDisabled();
  ...
  @DISPID(260) //= 0x104. The runtime will prefer the VTID if present
  @VTID(17)
  boolean getPostgapAlreadyInImage();
   ...
   * </p>
   * @return  Returns a value of type imapi2.IMAPI_FORMAT2_DATA_MEDIA_STATE
   */
   ...
   * </p>
   * @return  Returns a value of type imapi2.IMAPI_MEDIA_WRITE_PROTECT_STATE
   */

  @DISPID(263) //= 0x107. The runtime will prefer the VTID if present
  @VTID(19)
  imapi2.IMAPI_MEDIA_WRITE_PROTECT_STATE getWriteProtectStatus();
  ...
  @DISPID(269) //= 0x10d. The runtime will prefer the VTID if present
  @VTID(26)
  boolean getForceMediaToBeClosed();
  ...
  @VTID(27)
  void setDisableConsumerDvdCompatibilityMode(
    boolean value);
  ...
  @DISPID(270) //= 0x10e. The runtime will prefer the VTID if present
  @VTID(28)
  boolean getDisableConsumerDvdCompatibilityMode();
  ...
  @VTID(33)
  boolean getRequestedRotationTypeIsPureCAV();
  ...
  @VTID(35)
  boolean getCurrentRotationTypeIsPureCAV();
  ...
  @VTID(36)
  java.lang.Object[] getSupportedWriteSpeeds();
  ...
  @VTID(37)
  java.lang.Object[] getSupportedWriteSpeedDescriptors();

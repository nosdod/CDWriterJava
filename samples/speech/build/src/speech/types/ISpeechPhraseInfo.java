...
public interface ISpeechPhraseInfo extends Com4jObject {
  ...
  @VTID(15)
  @ReturnValue(defaultPropertyThrough={speech.types.ISpeechPhraseProperties.class})
  speech.types.ISpeechPhraseProperty properties(
    int index);
  ...
  @VTID(16)
  @ReturnValue(defaultPropertyThrough={speech.types.ISpeechPhraseElements.class})
  speech.types.ISpeechPhraseElement elements(
    int index);
  ...
  @VTID(17)
  @ReturnValue(defaultPropertyThrough={speech.types.ISpeechPhraseReplacements.class})
  speech.types.ISpeechPhraseReplacement replacements(
    int index);

...
public interface ISpeechRecoGrammar extends Com4jObject {
  ...
  @VTID(11)
  @ReturnValue(defaultPropertyThrough={speech.types.ISpeechGrammarRules.class})
  speech.types.ISpeechGrammarRule rules(
    int index);
   ...
   * @param info Mandatory speech.types.ISpeechTextSelectionInformation parameter.
   */
  ...
  @VTID(25)
  speech.types.SpeechWordPronounceable isPronounceable(

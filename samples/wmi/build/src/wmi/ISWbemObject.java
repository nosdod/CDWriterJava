...
public interface ISWbemObject extends Com4jObject {
   ...
   * @param objWbemNamedValueSet Optional parameter. Default value is unprintable.
   * @return  Returns a value of type wmi.ISWbemObjectSet
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(11)
  wmi.ISWbemObjectSet instances_(
  ...
  @VTID(13)
  wmi.ISWbemObjectSet subclasses_(
    @Optional @DefaultValue("16") int iFlags,
    @Optional @MarshalAs(NativeType.Dispatch) com4j.Com4jObject objWbemNamedValueSet);
  ...
  @VTID(15)
  wmi.ISWbemObjectSet associators_(
  ...
  @VTID(17)
  wmi.ISWbemObjectSet references_(
    @Optional @DefaultValue("") java.lang.String strResultClass,
    @Optional @DefaultValue("") java.lang.String strRole,
    @Optional @DefaultValue("0") boolean bClassesOnly,
    @Optional @DefaultValue("0") boolean bSchemaOnly,
  ...
  @VTID(23)
  wmi.ISWbemObject spawnDerivedClass_(
    @Optional @DefaultValue("0") int iFlags);
  ...
  @VTID(24)
  wmi.ISWbemObject spawnInstance_(
    @Optional @DefaultValue("0") int iFlags);
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemQualifierSet
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(26)
  wmi.ISWbemQualifierSet qualifiers_();


  @VTID(26)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemQualifierSet.class})
  wmi.ISWbemQualifier qualifiers_(
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemPropertySet
   */

  @DISPID(21) //= 0x15. The runtime will prefer the VTID if present
  @VTID(27)
  wmi.ISWbemPropertySet properties_();


  @VTID(27)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemPropertySet.class})
  wmi.ISWbemProperty properties_(
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemMethodSet
   */

  @DISPID(22) //= 0x16. The runtime will prefer the VTID if present
  @VTID(28)
  wmi.ISWbemMethodSet methods_();


  @VTID(28)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemMethodSet.class})
  wmi.ISWbemMethod methods_(
    java.lang.String strName,
    @Optional @DefaultValue("0") int iFlags);

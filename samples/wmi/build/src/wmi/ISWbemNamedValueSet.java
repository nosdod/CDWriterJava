...
public interface ISWbemNamedValueSet extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type wmi.ISWbemNamedValue
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(8)
  @DefaultMethod
  wmi.ISWbemNamedValue item(
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemNamedValueSet
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(12)
  wmi.ISWbemNamedValueSet clone();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemNamedValueSet.class})
  wmi.ISWbemNamedValue clone(
    java.lang.String strName,
    @Optional @DefaultValue("0") int iFlags);

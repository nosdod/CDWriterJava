...
public interface ISWbemRefresher extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(8)
  @DefaultMethod
  wmi.ISWbemRefreshableItem item(
    int iIndex);
   ...
   * </p>
   * @param objWbemServices Mandatory wmi.ISWbemServicesEx parameter.
  ...
  @VTID(10)
  wmi.ISWbemRefreshableItem add(
    wmi.ISWbemServicesEx objWbemServices,
  ...
  @VTID(11)
  wmi.ISWbemRefreshableItem addEnum(
    wmi.ISWbemServicesEx objWbemServices,

...
public interface ISWbemRefreshableItem extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemRefresher
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(8)
  wmi.ISWbemRefresher refresher();


  @VTID(8)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemRefresher.class})
  wmi.ISWbemRefreshableItem refresher(
    int iIndex);
   ...
   * </p>
   * @return  Returns a value of type wmi.ISWbemObjectEx
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(10)
  wmi.ISWbemObjectEx object();
  ...
  @VTID(11)
  wmi.ISWbemObjectSet objectSet();


  @VTID(11)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemObjectSet.class})
  wmi.ISWbemObject objectSet(

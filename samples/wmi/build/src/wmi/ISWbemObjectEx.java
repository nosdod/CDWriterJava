...
public interface ISWbemObjectEx extends wmi.ISWbemObject {
  // Methods:
  /**
   * <p>
   * Refresh this Object
  ...
  @VTID(33)
  wmi.ISWbemPropertySet systemProperties_();


  @VTID(33)
  @ReturnValue(defaultPropertyThrough={wmi.ISWbemPropertySet.class})
  wmi.ISWbemProperty systemProperties_(
   ...
   * </p>
   * @param iObjectTextFormat Mandatory wmi.WbemObjectTextFormatEnum parameter.
   * @param iFlags Optional parameter. Default value is 0
   * @param objWbemNamedValueSet Optional parameter. Default value is unprintable.
  ...
  java.lang.String getText_(
    wmi.WbemObjectTextFormatEnum iObjectTextFormat,
    @Optional @DefaultValue("0") int iFlags,
    @Optional @MarshalAs(NativeType.Dispatch) com4j.Com4jObject objWbemNamedValueSet);

...
public interface ISWbemPrivilegeSet extends Com4jObject,Iterable<Com4jObject> {
   ...
   * </p>
   * @param iPrivilege Mandatory wmi.WbemPrivilegeEnum parameter.
   * @return  Returns a value of type wmi.ISWbemPrivilege
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(8)
  @DefaultMethod
  wmi.ISWbemPrivilege item(
  ...
  @VTID(13)
  wmi.ISWbemPrivilege addAsString(

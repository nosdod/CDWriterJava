...
public interface OMathMatCols extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(12)
  @DefaultMethod
  word.OMathMatCol item(
    int index);


  /**
   * @param beforeCol Optional parameter. Default value is com4j.Variant.getMissing()
   * @return  Returns a value of type word.OMathMatCol
   */

  @DISPID(200) //= 0xc8. The runtime will prefer the VTID if present
  @VTID(13)
  word.OMathMatCol add(
    @Optional java.lang.Object beforeCol);

...
public interface ListTemplates extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(12)
  @DefaultMethod
  word.ListTemplate item(
    java.lang.Object index);


  /**
   * @param outlineNumbered Optional parameter. Default value is com4j.Variant.getMissing()
  ...
  @VTID(13)
  word.ListTemplate add(
    @Optional java.lang.Object outlineNumbered,
